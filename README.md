...
「音效」一列是当前最大的短板——只有迷宫穿越接了反馈层，其余都还是静默的。

- `guxing-maoxian` 菇星冒险 — 闯关 3 关：青草丘陵 / 砖窑遗迹 / 星塔之巅 — 无音效
- `xiaoxiaole` 甜果消消乐 — 闯关 5 关：果园初摘 / 蜜瓜小径 / 莓果集市 / 橙风长廊 / 甜果之巅 — 无音效
- `migong-chuansuo` 迷宫穿越 — 闯关 6 关：初启 / 错位 / 双阙 / 回环 / 叠城 / 终穿 — **有音效 + 触感 + 奖励反馈**
- `lvdong-danzhu` 律动弹珠 — 闯关 6 关：初拍热场 / 霓光副歌 / 碎拍回响 / 双色跃动 / 高速切分 / 终章律动 — 无音效（关卡表里已有 `bpm`，节奏却听不见，是最缺音效的一个）
- `chengshi-jianzao` 天际营造 — 闯关 6 关：落基镇 / 双溪口 / 工坊区 / 绿荫台 / 临港城 / 天际都 — 无音效
- `nizhe-yuanzheng` 泥辙远征 — 闯关 3 趟：木料上山 / 沼泽钢管 / 变压器过河 — 无音效
