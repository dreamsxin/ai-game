...
- `shici-jiangshan` 诗词江山图 — **不是游戏**，是一张《千里江山图》矿物色的 3D 诗词地图：唐宋元 133 首诗词曲、一枚印章管一处地方、9 条诗人行迹、3 朝 8 主题筛选 — **不打算加音效**（同上）
