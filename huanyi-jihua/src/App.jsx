...
const BEST_KEY = 'huanyi-jihua:best';
const MUTE_KEY = 'huanyi-jihua:muted';
...
export default function App() {
  ...
  return (
    <div className="app">
      ...
      <div className="stage">
        <div ref={hostRef} className="stage-host" aria-label="换翼计划关卡" />
      ...
      {overlay && (
        <div className="overlay" role="dialog" aria-modal="true">
          <div className={`panel${finished || cleared ? ' panel-settle' : ''}${selecting ? ' panel-wide' : ''}`}>
            <h1>{finished ? resultTitle(view.status) : selecting ? '选择机翼' : '换翼计划'}</h1>
