...
export const LEVEL = {
  ...
  anchors: [
    ...
    { id: 'phase', x: 13.5, z: -6.5, radius: 1.05, ability: 'phase', color: 0xd66cff },
  ],
  objects: [
    ...
    { id: 'prism-1', type: 'prism', x: 12, z: 14, size: 1.55, mass: 15, fuel: 18, color: 0xffca70 },
    ...
    { id: 'crystal-1', type: 'crystal', x: 11, z: 2, size: 1.85, mass: 24, fuel: 24, color: 0x8bf8ff },
    { id: 'cube-3', type: 'cube', x: -14, z: -11, size: 1.7, mass: 20, color: 0xb2ff78 },
    { id: 'crystal-2', type: 'crystal', x: -8, z: -13, size: 2.1, mass: 29, fuel: 28, color: 0xffca70 },
    { id: 'prism-3', type: 'prism', x: 3, z: -14, size: 2.25, mass: 38, fuel: 30, color: 0xff8ac6 },
